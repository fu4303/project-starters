    ...
    if (i) {
      ...
      (f = "scroll" + n.d2),
        w(
          ...
          n,
          (x && 20 < m) ||
            (!x && (u ? Math.max(Oe[f], _e[f]) : i.parentNode[f]) <= m + 1)
        ),
        u &&
          ((l = nt(a)),
    ...
    ((ScrollTrigger.prototype.init = function init(x, y) {
      if (((this.progress = 0), this.vars && this.kill(1), Je)) {
        var p,
          ...
          G,
          ee,
          te = (x = sa(S(x) || U(x) || x.nodeType ? { trigger: x } : x, it))
            .horizontal
            ? tt
            : rt,
          re = x.onUpdate,
        ...
        (Te.media = We),
                ...
                if (i <= _ && P <= i && a !== i) {
                  ...
                  p(
                    a,
                    {
                      duration: c(
                        Qe(
                          (0.185 * Math.max(Qe(n - e), Qe(o - e))) / t / 0.05 ||
                            0
                        )
                      ),
                      ease: de.ease || "power3",
          ...
          (Te.revert = function (e) {
            ...
            t !== w &&
              (t &&
                ((G = Math.max(Te.scroll(), Te.scroll.rec || 0)),
                ($ = Te.progress),
                (ee = y && y.progress())),
              O &&
          ...
          (Te.refresh = function (e) {
            if (!Re && Te.enabled)
              if (se && e && De) xa(ScrollTrigger, "scrollEnd", Qa);
                ...
                for (
                  P =
                    gb(v, ae, c, te, Te.scroll(), O, I, Te, u, ye, be, f) ||
                    (se ? -0.001 : 0),
                    T(g) && (g = g(Te)),
                    S(g) &&
                      !g.indexOf("+=") &&
                ...
                if (
                  ...
                  (t = qa(se)),
                    ...
                    !f &&
                      1 < _ &&
                      ((ve ? Oe : he).style["overflow-" + te.a] = "scroll"),
                    ab(se, B, t),
                    (W = db(se)),
                    (r = nt(se, !0)),
                    (l = be && M(he, o ? tt : rt)()),
                  ...
                  for (r = ae.parentNode; r && r !== Oe; )
                    r._pinOffset && ((P -= r._pinOffset), (_ -= r._pinOffset)),
                      (r = r.parentNode);
                for (m = 0; m < b; m++)
                  !(a = at[m].pin) ||
                    (a !== ae && a !== se) ||
          ...
          (Te.update = function (e, t) {
            ...
            if (
              (t &&
                ((k = C),
                (C = s),
                de && ((X = m), (m = y && !ge ? y.totalProgress() : c))),
              ue &&
                !c &&
                se &&
                !Re &&
              ...
              if (
                ...
                ge ||
                  (!Y || Re || Be
                    ...
                    : ((Y.vars.totalProgress = c), Y.invalidate().restart())),
                se)
              )
                if ((e && le && (B.style[le + te.os2] = h), be)) {
                  if (i) {
                    if (
                      ((o = !e && u < c && s < _ + 1 && s + 1 >= Q(he, te)), pe)
                    )
                      if (e || (!r && !o)) ib(se, B);
                      else {
                        var f = nt(se, !0),
